...
<head>
    ...
    <!-- Bootstrap CDN --><!--para que funcione Bootstrap se inserta esta línea-->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" integrity="sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh" crossorigin="anonymous">
    <!-- Jquery --><!--para que funcione JQuery se inserta esta línea-->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <!--Fontawesome CDN--> <!--Para que funcionen los iconos se pone la línea de abajo, la de fontawesome-->
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
    <title>Repartos</title>
    <script src="../js/funciones.js"></script>
    <script>
        //aquí puede ir el script que hemos añadido en funciones.js
    </script>
</head>
...
?>
    ...
    <div class="container mt-4" style='width:80rem;'>
        ...
        foreach ($listas->getItems() as $lista) {
            ...
            echo "<th scope='col' colspan='2' class='text-right'>\n";
            ...
            //modificamos a por button y añadimos onClick
            ...
            $tareas = getTareas($lista->getId());//$lista->getId() --> cada lista de reparto tiene su id

            foreach ($tareas->getItems() as $tarea) {
                $c   = explode(",", $tarea->getNotes());//$tarea->getNotes() --> latitud y longitud
                $lat = $c[0];
                $lon = count($c) < 2 ? "" : $c[1];
                echo "<tr>\n";
