<?php
$url = 'http://127.0.0.1/dwes06_WSDL_funcionalidad_agregada/TAREA_06/servidorSoap/servicioW.php'; //se hace llamada a este servicio que se crea
$uri = 'http://127.0.0.1/dwes06_WSDL_funcionalidad_agregada/TAREA_06/servidorSoap';
...
$nombre = 'CENTRAL'; //parámetro de nombre de la tienda
...
// funcion getTelf------------------------------------------------------------------------------
$telefono = $cliente->__soapCall('getTlfTienda', ['nombre'=>$nombre]);
